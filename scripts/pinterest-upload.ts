...
async function main() {
  try {
    const content: PinContent = {
      imageName: 'decimalcalculator.webp',
      title: 'Free Online Decimal to Fraction Calculator | Convert Decimals Instantly',
      description: 'Convert any decimal to a fraction instantly with our free calculator!\n\n' +
        'Features:\n' +
        '- Convert decimals to simplified fractions\n' +
        '- Handle both terminating and repeating decimals\n' +
        '- Show mixed number representation\n' +
        '- Display percentage equivalent\n' +
        '- Automatic simplification\n\n' +
        'Try our FREE calculator at CalculatorOf.com!\n\n' +
        '#DecimalCalculator #FractionConverter #MathTools #OnlineCalculator #MathHelp',
      tags: [
        'decimal calculator',
        'fraction converter',
        'math calculator',
