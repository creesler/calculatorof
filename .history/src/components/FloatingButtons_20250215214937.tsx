  ...
  return (
    <>
      ...
      {platform && (platform === 'ios' || deferredPrompt) && showInstallPrompt && (
        <div 
          className="fixed top-4 left-4 right-4 bg-white p-4 rounded-lg shadow-lg z-50 md:left-auto md:right-4 md:w-96 border border-gray-200
                     transform transition-all duration-300 ease-out
                     translate-y-0 opacity-100
                     enter:translate-y-[-100%] enter:opacity-0"
        >
          {/* Close button */}
          <button
