...
export default function FloatingButtons() {
  ...
  useEffect(() => {
    ...
    const detectPlatform = () => {
      ...
      if (/iPad|iPhone|iPod/.test(userAgent) && /WebKit/.test(userAgent) && !/(CriOS|FxiOS|OPiOS|mercury)/.test(userAgent)) {
        setPlatform('ios')
    ...
    // Only check PWA criteria in development
