    ...
    <>
      ...
      {platform && (platform === 'ios' || deferredPrompt) && showInstallPrompt && (
        <>
          ...
          {/* Modal Content */}
          <div className="fixed top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 bg-white p-6 rounded-lg shadow-xl z-50 w-80 border border-gray-200">
            {/* Close button */}
            <button
              onClick={() => setShowInstallPrompt(false)}
            ...
            {/* Content */}
            <div>
              <h3 className="text-lg font-semibold text-center">Install Calculator Suite</h3>
              ...
              >
                Install {platform === 'ios' ? 'on iOS' : platform === 'android' ? 'on Android' : 'on Windows'}
              </button>
            </div>
          </div>
        </>
