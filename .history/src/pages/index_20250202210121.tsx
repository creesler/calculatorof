...
export default function Home() {
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      <Head>
        <title>Calculator Hub | Free Online Calculators for Every Need</title>
        <meta 
          name="description" 
          content="Free online calculators for finance, health, pets, and math. Easy-to-use tools for all your calculation needs." 
        />
        <meta name="keywords" content="calculator, finance calculator, health calculator, pet calculator, math calculator, ROI calculator, BMI calculator" />
        <meta property="og:title" content="Calculator Hub | Free Online Calculators" />
        ...
        <meta name="twitter:title" content="Calculator Hub | Free Online Calculators" />
      ...
      <main className="container mx-auto px-4 py-8">
        <h1 className="text-4xl font-bold text-center mb-8">Calculator Hub</h1>
        ...
        <article className="prose lg:prose-xl mx-auto mt-12 px-4">
          ...
          <p>
            Welcome to Calculator Hub, your one-stop destination for all types of calculators. 
