...
export default function LoanCalculator() {
  ...
  const handleCalculate = (e: FormEvent<HTMLFormElement>) => {
    ...
    const parsedInputs: LoanInputs = {
      loanAmount: parseFloat(inputs.loanAmount) || 0,
      interestRate: parseFloat(inputs.interestRate) || 0,
      loanTerm: parseFloat(inputs.loanTerm) || 0,
      paymentFrequency: inputs.paymentFrequency
    };

    // Only calculate if we have valid numbers
    if (parsedInputs.loanAmount && parsedInputs.interestRate && parsedInputs.loanTerm) {
      const calculatedResults = calculateLoan(parsedInputs);
      ...
      <div className="min-h-screen bg-gray-50 relative">
        ...
        <main className="container mx-auto px-4 py-8">
          <div className="mb-8 text-center">
            ...
            <ShareButtons 
              title="Loan Calculator - CalculatorOf.com"
              description="Calculate your loan payments, interest, and amortization schedule with this free online calculator"
            />
          </div>
