              ...
              <div className="flex flex-col items-center justify-center space-y-4">
                <label className="flex items-center cursor-pointer">
                  <input
                    ...
                    className="hidden"
                  />
                  <span className="w-10 h-10 flex items-center justify-center text-xl font-bold rounded-full border-2 border-gray-300 hover:border-blue-500 
                    {inputs.operation === 'add' ? 'bg-blue-500 text-white border-blue-500' : 'bg-white text-gray-700'}">
                    +
                  </span>
                </label>
                <label className="flex items-center cursor-pointer">
                  ...
                  />
                  <span className="w-10 h-10 flex items-center justify-center text-xl font-bold rounded-full border-2 border-gray-300 hover:border-blue-500 
                    {inputs.operation === 'subtract' ? 'bg-blue-500 text-white border-blue-500' : 'bg-white text-gray-700'}">
                    −
                  </span>
                </label>
                <label className="flex items-center cursor-pointer">
                  ...
                  />
                  <span className="w-10 h-10 flex items-center justify-center text-xl font-bold rounded-full border-2 border-gray-300 hover:border-blue-500 
                    {inputs.operation === 'multiply' ? 'bg-blue-500 text-white border-blue-500' : 'bg-white text-gray-700'}">
                    ×
                  </span>
                </label>
                <label className="flex items-center cursor-pointer">
                  ...
                  />
                  <span className="w-10 h-10 flex items-center justify-center text-xl font-bold rounded-full border-2 border-gray-300 hover:border-blue-500 
                    {inputs.operation === 'divide' ? 'bg-blue-500 text-white border-blue-500' : 'bg-white text-gray-700'}">
                    ÷
                  </span>
                </label>
              </div>
