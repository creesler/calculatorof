            ...
            <details className="bg-white rounded-lg shadow-lg">
              ...
              <div className="px-6 pb-6">
                <div className="prose max-w-none">
                  ...
                  <h3>Example Calculation</h3>
                  <Image
                    src="/images/mixednumbers.webp"
                    alt="Mixed numbers calculator demonstration: Example shows adding 1¾ + 2½ = 4¼, with step-by-step conversion to improper fractions (7/4 + 5/2 = 17/4). Perfect for students learning mixed number arithmetic and teachers explaining fraction operations."
                    width={800}
                    height={400}
                    className="rounded-lg shadow-lg mb-4"
                    priority
                  />
                  <p className="text-sm text-gray-600 mb-6">
                    Example: Adding mixed numbers 1¾ + 2½ = 4¼, showing the conversion process and final result.
                  </p>
