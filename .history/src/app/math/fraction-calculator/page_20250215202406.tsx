...
export default function FractionCalculator() {
  ...
  const [simplifyInputs, setSimplifyInputs] = useState({
    whole: 0,
    num: 0,
    den: 1
  });
              ...
              <div className="flex flex-col items-center w-full sm:w-auto">
                ...
                <NumericInput
                  ...
                  onChange={(value) => setInputs({
                    ...inputs,
                    num1: value === '' ? 0 : parseInt(value.toString())
                  })}
                  defaultValue="0"
                />
                ...
                <div className="flex flex-col items-center w-full sm:w-auto">
                  ...
                  <div className="flex items-center gap-2">
                    <NumericInput
                      ...
                      onChange={(value) => setMixedInputs({
                        ...mixedInputs,
                        whole1: value === '' ? 0 : parseInt(value.toString())
                      })}
                      defaultValue="0"
                    />
            ...
            <form onSubmit={(e) => {
              ...
              <div className="flex items-center justify-center gap-4">
                ...
                <div className="flex flex-col items-center">
                  ...
                  <NumericInput
                    value={Number((e.currentTarget.elements.namedItem('simplifyWhole') as HTMLInputElement).value) || 0}
                    onChange={(value) => {
                      (e.currentTarget.elements.namedItem('simplifyWhole') as HTMLInputElement).value = value.toString();
                    }}
                ...
                <div className="flex flex-col items-center">
                  ...
                  <NumericInput
                    value={Number((e.currentTarget.elements.namedItem('simplifyNum') as HTMLInputElement).value) || 0}
                    onChange={(value) => {
                      (e.currentTarget.elements.namedItem('simplifyNum') as HTMLInputElement).value = value.toString();
                    }}
                    className="w-20 p-2 border rounded text-center"
                  />
                  <div className="my-1 border-t border-black w-20"></div>
                  <NumericInput
                    value={Number((e.currentTarget.elements.namedItem('simplifyDen') as HTMLInputElement).value) || 1}
                    onChange={(value) => {
                      (e.currentTarget.elements.namedItem('simplifyDen') as HTMLInputElement).value = value.toString();
                    }}
                    className="w-20 p-2 border rounded text-center"
                  />
          ...
          <div className="bg-white rounded-lg shadow-lg p-4 sm:p-6">
            <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
              ...
              <div className="flex flex-col items-center w-full sm:w-auto">
                ...
                <NumericInput
                  value={decimalInput}
                  onChange={(value) => setDecimalInput(value.toString())}
                  allowDecimal={true}
                  defaultValue="0"
                />
              </div>
                ...
                <div className="flex flex-col items-center">
                  ...
                  <NumericInput
                    ...
                    onChange={(value) => {
                      setFractionInput({
                        ...fractionInput,
                        numerator: value === '' ? 0 : parseInt(value.toString())
                      })
                    }}
                    onFocus={(e) => e.target.value === '0' && setFractionInput({...fractionInput, numerator: 0})}
                    className="w-32 p-2 border rounded text-center"
                  />
                  <div className="my-1 border-t border-black w-20"></div>
                  <NumericInput
                    value={fractionInput.denominator}
                    onChange={(value) => setFractionInput({
                      ...fractionInput,
                      denominator: Number(value.toString())
                    })}
                    onFocus={(e) => e.target.value === '1' && setFractionInput({...fractionInput, denominator: 1})}
                    className="w-32 p-2 border rounded text-center"
                  />
                </div>
              ...
              <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
                ...
                <div className="flex flex-col items-center w-full sm:w-auto">
                  ...
                  <NumericInput
                    ...
                    onChange={(value) => setBigFractionInput({
                      ...bigFractionInput,
                      num1: value.toString().replace(/[^0-9]/g, '')
                    })}
                    onFocus={(e) => e.target.value === '0' && setBigFractionInput({...bigFractionInput, num1: '0'})}
                    className="w-32 p-2 border rounded text-center"
                  />
                  <div className="my-1 border-t border-black w-20"></div>
                  <NumericInput
                    ...
                    onChange={(value) => setBigFractionInput({
                      ...bigFractionInput,
                      den1: value.toString().replace(/[^0-9]/g, '')
                    })}
                    onFocus={(e) => e.target.value === '1' && setBigFractionInput({...bigFractionInput, den1: '1'})}
                    className="w-32 p-2 border rounded text-center"
                  />
                </div>
                ...
                <div className="flex flex-col items-center w-full sm:w-auto">
                  ...
                  <NumericInput
                    ...
                    onChange={(value) => setBigFractionInput({
                      ...bigFractionInput,
                      num2: value.toString().replace(/[^0-9]/g, '')
                    })}
                    onFocus={(e) => e.target.value === '0' && setBigFractionInput({...bigFractionInput, num2: '0'})}
                    className="w-32 p-2 border rounded text-center"
                  />
                  <div className="my-1 border-t border-black w-20"></div>
                  <NumericInput
                    ...
                    onChange={(value) => setBigFractionInput({
                      ...bigFractionInput,
                      den2: value.toString().replace(/[^0-9]/g, '')
                    })}
                    onFocus={(e) => e.target.value === '1' && setBigFractionInput({...bigFractionInput, den2: '1'})}
                    className="w-32 p-2 border rounded text-center"
                  />
                </div>
