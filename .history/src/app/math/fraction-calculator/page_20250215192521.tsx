  ...
  return (
    <div className="min-h-screen bg-gray-50 relative">
      ...
      <main className="container mx-auto px-4 py-8">
        ...
        {/* Advanced Fraction Operations Calculator */}
        <div className="max-w-2xl mx-auto mt-12">
          <h2 className="text-2xl font-bold mb-4">Advanced Fraction Operations Calculator</h2>
          <div className="bg-white rounded-lg shadow-lg p-6">
            {/* Description */}
            <p className="text-gray-600 mb-4">
              Perform precise calculations with large fractions. Perfect for complex mathematical operations, 
              engineering calculations, and advanced problem-solving.
            </p>
          ...
          {/* Info Section - Updated content */}
          <div className="mt-4 bg-white rounded-lg shadow-lg p-6">
            <h3 className="font-semibold mb-3">About Advanced Fraction Operations Calculator</h3>
            <p className="text-gray-600 mb-4">
              This advanced calculator handles complex fraction operations with high precision. 
              Ideal for students, engineers, and professionals working with large numerical calculations.
            </p>
            
            <div className="text-sm text-gray-600">
              <p className="font-semibold mb-2">Calculator Features:</p>
              <ul className="list-disc pl-5 space-y-1">
