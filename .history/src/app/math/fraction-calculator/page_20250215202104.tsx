            ...
            <div className="flex flex-col sm:flex-row items-center justify-center sm:justify-between gap-6 sm:px-4">
              ...
              <div className="flex flex-col items-center w-full sm:w-auto">
                ...
                <input 
                  ...
                  onFocus={(e) => e.target.value === '0' && setInputs({...inputs, num1: ''})}
                ...
                <input
                  ...
                  onFocus={(e) => e.target.value === '1' && setInputs({...inputs, den1: 1})}
                  className="w-32 p-2 border rounded text-center"
                  placeholder="1"
                />
              </div>
              ...
              <div className="flex flex-col items-center w-full sm:w-auto">
                ...
                <input
                  ...
                  onFocus={(e) => e.target.value === '0' && setInputs({...inputs, num2: 0})}
                  className="w-32 p-2 border rounded text-center"
                  placeholder="0"
                />
                <div className="my-1 border-t border-black w-20"></div>
                <input
                  ...
                  onFocus={(e) => e.target.value === '1' && setInputs({...inputs, den2: 1})}
                  className="w-32 p-2 border rounded text-center"
                  placeholder="1"
                />
              </div>
                ...
                <div className="flex flex-col items-center w-full sm:w-auto">
                  ...
                  <div className="flex items-center gap-2">
                    <input 
                      ...
                      onFocus={(e) => e.target.value === '0' && setMixedInputs({...mixedInputs, whole1: 0})}
                    ...
                    <div className="flex flex-col">
                      <input 
                        ...
                        onFocus={(e) => e.target.value === '0' && setMixedInputs({...mixedInputs, num1: 0})}
                        className="w-20 p-2 border rounded text-center"
                      />
                      ...
                      <input 
                        ...
                        onFocus={(e) => e.target.value === '1' && setMixedInputs({...mixedInputs, den1: 1})}
                        className="w-20 p-2 border rounded text-center"
                      />
                    </div>
                  </div>
                ...
                <div className="flex flex-col items-center w-full sm:w-auto">
                  ...
                  <div className="flex items-center gap-2">
                    <input 
                      ...
                      onFocus={(e) => e.target.value === '0' && setMixedInputs({...mixedInputs, whole2: 0})}
                      className="w-20 p-2 border rounded text-center"
                    />
                    <div className="flex flex-col">
                      <input 
                        ...
                        onFocus={(e) => e.target.value === '0' && setMixedInputs({...mixedInputs, num2: 0})}
                        className="w-20 p-2 border rounded text-center"
                      />
                      <div className="my-1 border-t border-black w-full"></div>
                      <input 
                        ...
                        onFocus={(e) => e.target.value === '1' && setMixedInputs({...mixedInputs, den2: 1})}
                        className="w-20 p-2 border rounded text-center"
                      />
                    </div>
                  </div>
              ...
              <div className="flex items-center justify-center gap-4">
                ...
                <div className="flex flex-col items-center">
                  ...
                  <input
                    ...
                    className="w-20 p-2 border rounded text-center"
                    placeholder="2"
                    onFocus={(e) => e.target.value === '0' && setSimplifyResult(null)}
                  />
                </div>
                ...
                <div className="flex flex-col items-center">
                  ...
                  <input
                    ...
                    className="w-20 p-2 border rounded text-center"
                    placeholder="98"
                    onFocus={(e) => e.target.value === '1' && setSimplifyResult(null)}
                  />
            ...
            <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
              ...
              <div className="flex flex-col items-center w-full sm:w-auto">
                ...
                <input 
                  ...
                  onFocus={(e) => e.target.value === '0' && setFractionResult(null)}
                  className="w-32 p-2 border rounded text-center"
                />
              </div>
