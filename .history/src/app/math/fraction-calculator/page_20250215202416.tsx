          ...
          <div className="bg-white rounded-lg shadow-lg p-6">
            <div className="flex items-center justify-center gap-4">
              ...
              <div className="flex flex-col items-center">
                ...
                <NumericInput
                  value={simplifyInputs.whole}
                  onChange={(value) => setSimplifyInputs({
                    ...simplifyInputs,
                    whole: value === '' ? 0 : parseInt(value.toString())
                  })}
                  defaultValue="0"
              ...
              <div className="flex flex-col items-center">
                ...
                <NumericInput
                  value={simplifyInputs.num}
                  onChange={(value) => setSimplifyInputs({
                    ...simplifyInputs,
                    num: value === '' ? 0 : parseInt(value.toString())
                  })}
                  defaultValue="0"
                  className="w-20 p-2 border rounded text-center"
                />
                <div className="my-1 border-t border-black w-20"></div>
                <NumericInput
                  value={simplifyInputs.den}
                  onChange={(value) => setSimplifyInputs({
                    ...simplifyInputs,
                    den: value === '' ? 1 : parseInt(value.toString())
                  })}
                  defaultValue="1"
                  className="w-20 p-2 border rounded text-center"
                />
              ...
              <button
                onClick={() => {
                  const improperNum = simplifyInputs.whole * simplifyInputs.den + simplifyInputs.num;
                  const simplified = simplifyFraction(improperNum, simplifyInputs.den);
