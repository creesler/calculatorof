              ...
              <div className="px-6 pb-6">
                <div className="prose max-w-none">
                  ...
                  <Image
                    ...
                    alt="Essential fraction to decimal conversion formulas: Learn how to convert fractions to decimals using division (3/4 = 0.75) and express in scientific notation (7.5 × 10⁻¹). Perfect for algebra, pre-calculus, and standardized test prep. Includes percentage conversion and multiple formats."
                    width={800}
                    height={200}
                    className="rounded-lg shadow-md my-4"
                    priority
                  />
                  <p className="text-sm text-gray-600 mb-6">
                    Step-by-step formulas for converting fractions to decimals, showing division method and scientific notation.
                  </p>
                </div>
              </div>
            </details>
