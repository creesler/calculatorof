            ...
            <form onSubmit={(e) => {
              ...
              <div className="flex items-center justify-center gap-4">
                ...
                <input
                  type="number"
                  name="simplifyNum"
                  className="w-24 h-10 text-lg border rounded text-center"
                  placeholder="0"
                />
              ...
              <div className="flex items-center justify-center gap-4 mt-4">
                <button
                  type="submit"
                  className="px-8 py-2 bg-green-600 text-white rounded hover:bg-green-700 flex items-center gap-2"
                >
                  Calculate <span className="text-xl">▶</span>
                </button>
                <button
                  type="reset"
                  className="px-8 py-2 bg-gray-400 text-white rounded hover:bg-gray-500"
                >
                  Clear
                </button>
              </div>
