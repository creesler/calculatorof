      ...
      <main className="container mx-auto px-4 py-8">
        ...
        <div className="max-w-2xl mx-auto mt-12">
          ...
          <div className="bg-white rounded-lg shadow-lg p-6">
            <div className="space-y-6">
              ...
              <p className="text-gray-600">
                Enter large numbers to calculate their simplified fraction. This calculator can handle very large integers.
              </p>
              ...
              <div className="flex flex-col items-center gap-6">
                ...
                <div className="flex flex-col items-center">
                  <input 
                    ...
                    value={bigFractionInput.numerator}
                    onChange={(e) => setBigFractionInput({
                      ...bigFractionInput,
                      numerator: e.target.value.replace(/[^0-9]/g, '')
                    })}
                    className="w-64 p-2 border rounded text-center"
                  />
                  <div className="my-2 border-t-2 border-black w-64"></div>
                  <input 
                    type="text" 
                    placeholder="Enter denominator"
                    value={bigFractionInput.denominator}
                    onChange={(e) => setBigFractionInput({
                      ...bigFractionInput,
                      denominator: e.target.value.replace(/[^0-9]/g, '')
                    })}
                    className="w-64 p-2 border rounded text-center"
                  />
                </div>
                ...
                <button
                  ...
                  type="button"
                  className="px-8 py-2 bg-blue-600 text-white rounded hover:bg-blue-700 w-64"
                >
                  Calculate
                </button>
                ...
                {bigFractionResult && (
                  <div className="w-full max-w-lg">
                    <div className="bg-gray-50 p-4 rounded-lg">
                      <p className="font-semibold text-gray-700 mb-3">Simplified Fraction:</p>
                      <div className="flex flex-col items-center">
                        <div className="w-full px-4 py-2 bg-white rounded border text-center break-all">
                          {bigFractionResult.numerator}
                        </div>
                        <div className="my-1 border-t-2 border-black w-full"></div>
                        <div className="w-full px-4 py-2 bg-white rounded border text-center break-all">
              ...
              <div className="mt-8">
                ...
                <div className="grid grid-cols-2 gap-4 text-sm text-gray-600">
                  ...
                  <div>
                    ...
                    <p>Simplified: 13717421/109739369</p>
                  </div>
                </div>
              </div>
            </div>
          ...
          <div className="mt-4">
            <details className="bg-white rounded-lg shadow-lg">
              <summary className="p-6 text-lg font-semibold cursor-pointer hover:bg-gray-50">
                More Details About Big Number Fraction Calculator
              </summary>
              <div className="px-6 pb-6">
                <div className="prose max-w-none">
                  <p>
                    This calculator handles very large integers and simplifies them to their lowest terms. 
                    It's useful for working with big numbers that regular calculators can't handle.
                  </p>

                  <h3>Features</h3>
                  <ul className="list-disc pl-5 space-y-1">
                    <li>Handles large integers (up to 20 digits or more)</li>
                    <li>Automatically simplifies to lowest terms</li>
                    <li>Shows result in fraction format</li>
                    <li>No scientific notation - shows complete numbers</li>
                  </ul>

                  <div className="bg-gray-50 p-4 rounded-lg my-4">
                    <p className="font-semibold mb-2">Usage Tips:</p>
                    <ul className="list-disc pl-5 space-y-1">
                      <li>Enter whole numbers only (no decimals)</li>
                      <li>Don't use commas in large numbers</li>
                      <li>Denominator cannot be zero</li>
                      <li>For best results, use numbers under 20 digits</li>
                    </ul>
                  </div>
                </div>
              </div>
