...
export default function FractionCalculator() {
  ...
  const handleCalculate = (e: FormEvent) => {
    ...
    switch (inputs.operation) {
      case 'add':
        num = parseInt(inputs.num1) * parseInt(inputs.den2) + parseInt(inputs.num2) * parseInt(inputs.den1)
        den = parseInt(inputs.den1) * parseInt(inputs.den2)
        break
      case 'subtract':
        num = parseInt(inputs.num1) * parseInt(inputs.den2) - parseInt(inputs.num2) * parseInt(inputs.den1)
        den = parseInt(inputs.den1) * parseInt(inputs.den2)
        break
      case 'multiply':
        num = parseInt(inputs.num1) * parseInt(inputs.num2)
        den = parseInt(inputs.den1) * parseInt(inputs.den2)
        break
      case 'divide':
        num = parseInt(inputs.num1) * parseInt(inputs.den2)
        den = parseInt(inputs.den1) * parseInt(inputs.num2)
        break
      default:
        return
    }
