      ...
      <main className="container mx-auto px-4 py-8">
        ...
        <div className="max-w-2xl mx-auto mt-8 bg-white rounded-lg shadow-lg p-6">
          ...
          <Image
            ...
            alt="Fraction calculator formulas showing: Addition (a/b + c/d = (ad+bc)/bd), Subtraction (a/b - c/d = (ad-bc)/bd), Multiplication (a/b × c/d = ac/bd), and Division (a/b ÷ c/d = ad/bc)"
            width={800}
            height={200}
        ...
        <article className="prose lg:prose-xl mx-auto mt-12">
          ...
          <div className="my-8">
            <Image
              ...
              alt="Fraction Calculator showing example calculation: 3/4 + 1/2 = 5/4 with decimal (1.250), mixed number (1 1/4), and percentage (125.0%) representations"
              width={800}
              height={400}
