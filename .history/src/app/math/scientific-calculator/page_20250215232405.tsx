    ...
    <div className="min-h-screen bg-gray-50 relative">
      ...
      <main className="container mx-auto px-4 py-8">
        <div className="mb-8 text-center">
          ...
          <ShareButtons 
            title="Scientific Calculator - CalculatorOf.com"
            description="Perform complex mathematical calculations with this free online scientific calculator. Features trigonometry, logarithms, and more."
          />
        </div>
