    ...
    <div className="min-h-screen bg-gray-50 relative">
      ...
      <main className="container mx-auto px-4 py-8">
        <div className="mb-8 text-center">
          ...
          <ShareButtons 
            title="Calorie Calculator - CalculatorOf.com"
            description="Calculate your daily calorie needs with this free online calculator. Get personalized nutrition recommendations based on your goals."
          />
        </div>
