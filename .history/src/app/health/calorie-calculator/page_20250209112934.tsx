          ...
          <form onSubmit={handleCalculate} className="space-y-4">
            ...
            <div>
              <label className="block text-sm font-medium text-gray-700">
                ...
                <select
                  value={inputs.goal}
                  onChange={(e) => setInputs({...inputs, goal: e.target.value as 'maintain' | 'lose' | 'gain'})}
                  className="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500"
                >
          ...
          {results && (
            <div className="mt-8 space-y-4">
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                ...
                <div className="bg-gray-50 p-4 rounded-lg">
                  <h3 className="text-lg font-medium">Total Daily Energy</h3>
                  <p className="text-2xl font-bold text-purple-600">{results.totalDailyEnergy} calories</p>
                </div>
              </div>
            </div>
          )}
