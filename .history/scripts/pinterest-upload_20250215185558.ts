...
function getDescriptionForImage(imageName: string): string {
  const descriptions: Record<string, string> = {
    ...
    'decimal-formula.webp': 'Convert decimals to fractions easily with our step-by-step calculator! Learn how to handle both terminating and repeating decimals. #math #fractions #education #calculator',
    'decimalcalculator.webp': 'Free online decimal to fraction converter with instant results and explanations. Perfect for homework and learning! #math #decimals #fractions #education'
  }
...
function getAltTextForImage(imageName: string): string {
  const altTexts: Record<string, string> = {
    ...
    // Add new alt texts
    'decimal-formula.webp': 'Step-by-step formulas showing how to convert decimals to fractions, including both terminating and repeating decimals',
    'decimalcalculator.webp': 'Decimal to fraction calculator example showing conversion of 0.75 to 3/4 with additional formats'
  }
